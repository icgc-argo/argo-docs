...
Data files containing the simple Insertions and Deletions (InDel) variants which were filtered through each caller's PASS tag and within only the open access regions.
