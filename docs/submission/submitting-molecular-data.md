...
To efficiently handle submitting multiple samples in parallel, we suggest to run the submission workflow for each sample with different launch directory.
