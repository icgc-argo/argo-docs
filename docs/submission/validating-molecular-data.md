...
| **read_group_id_in_bam** | read_groups |   |  Optional field indicating the @RD ID in the BAM.  If submitted, this will be used to map the @RG ID in the BAM header to the `submitter_read_group_id` in the payload.  After submission, the @RG ID in the payload will be used for all future headers.  This **cannot** be submitted for FASTQ files. |                                                                      |  
