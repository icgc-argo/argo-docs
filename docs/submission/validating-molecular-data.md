...
- The Song payload as a `.json` file (for instructions on preparing payloads please see [Submitting Molecular Data](/docs/submission/submitting-molecular-data)).  Only 1 `.json` file must be present in the submission folder.
